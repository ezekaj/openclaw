...
import { ArrowUpRight, Terminal, Send, Zap, CheckCircle, AlertCircle, RefreshCw, Github, Linkedin, Twitter, Instagram } from 'lucide-react';
...
const SOCIAL_LINKS = [
  { name: 'Instagram', icon: Instagram, url: 'https://instagram.com/zedigitaltech' },
  { name: 'GitHub', icon: Github, url: 'https://github.com/zedigitaltech' },
  { name: 'LinkedIn', icon: Linkedin, url: 'https://linkedin.com/company/zedigitaltech' },
  { name: 'X', icon: Twitter, url: 'https://x.com/zedigitaltech' },
];
