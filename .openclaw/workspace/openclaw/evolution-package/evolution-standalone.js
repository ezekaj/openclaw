...
async function generateProposal(code, file) {
  const systemPrompt = `You are an autonomous code evolution agent.

RULES:
1. Generate unified diff patches to improve code
...
Return JSON only with improvement proposal.`;
