...
async function runEvolution() {
    const orchestrator = new orchestrator_1.EvolutionOrchestrator({
...
async function testSandbox() {
    ...
    const sandbox = new sandbox_1.SandboxRunner({
        openclawDir: OPENCLAW_DIR,
        sandboxBase: SANDBOX_BASE
    });
    ...
    // Test a simple patch
    const result = await sandbox.applyPatch(sandboxPath, 'package.json', '"name": "openclaw"', '"name": "openclaw-test"');
