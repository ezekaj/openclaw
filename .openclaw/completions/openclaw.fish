...
complete -c openclaw -n "__fish_use_subcommand" -a "heartbeat-v2" -d 'Production heartbeat system management'
...
complete -c openclaw -n "__fish_seen_subcommand_from heartbeat-v2" -a "status" -d 'Show heartbeat system status'
complete -c openclaw -n "__fish_seen_subcommand_from heartbeat-v2" -a "trigger" -d 'Trigger immediate heartbeat for an agent'
complete -c openclaw -n "__fish_seen_subcommand_from heartbeat-v2" -a "pause" -d 'Pause heartbeats for an agent'
complete -c openclaw -n "__fish_seen_subcommand_from heartbeat-v2" -a "resume" -d 'Resume heartbeats for an agent'
complete -c openclaw -n "__fish_seen_subcommand_from heartbeat-v2" -a "analytics" -d 'Show analytics for an agent'
complete -c openclaw -n "__fish_seen_subcommand_from status" -s a -l agent -d 'Agent ID to check'
complete -c openclaw -n "__fish_seen_subcommand_from trigger" -s r -l reason -d 'Reason for trigger'
complete -c openclaw -n "__fish_seen_subcommand_from pause" -s r -l reason -d 'Reason for pause'
complete -c openclaw -n "__fish_seen_subcommand_from analytics" -s t -l time-range -d 'Time range (1h, 24h, 7d, 30d)'
